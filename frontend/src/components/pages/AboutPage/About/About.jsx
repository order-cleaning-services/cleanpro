			...
			<div className="about">
				<div className="about__container-statistics">
					...
					<div className="about__card-statistics">
						...
						<p className="about__card-subtitle text-s">клиентов<br />воспользовались нашими&nbsp;услугами</p>
					</div>
					<div className="about__card-statistics">
						<p className="about__card-title">100</p>
						<p className="about__card-subtitle text-s">клинеров<br />осуществляют<br />качеcтвенную работу</p>
					</div>
				</div>
